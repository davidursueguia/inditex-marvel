...
const CharacterInfo = ({ character }: CharacterInfoProps) => (
  <div className="bg-black flex flex-col md:!flex-row lg:!flex-row w-full justify-self-center text-white px-4 lg:px-0">
    <div className="w-full lg:w-64 h-64 overflow-hidden rounded-lg shadow-lg mb-4 lg:mb-0 max-w-[960px]">
      <img
    ...
    <div className="lg:ml-8 flex flex-col justify-center w-full">
      ...
      <p className="mt-2 text-gray-300 text-sm sm:text-base sm:text-start sm:ml-7 sm:pb-9">
    ...
    <img
      src={cut}
      alt="cut"
      className="sticky right-0 bottom-0 self-end mb-[-1px] mr-[-1px]"
    />
  </div>
);
